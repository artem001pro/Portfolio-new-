$(document).ready(function() {
    ...
    var typed = new Typed(".element",{
      strings: ['Muslim', 'a Developer', 'a Designer', 'a Businessman'],
      smartBackspace: true,
      typeSpeed:100,
      backSpeed:100,
      loop:true,
    ...
    let iconbtn = document.querySelector('.navbar-toggler'),
        navbarbtn = document.querySelector('#navbarId'),
        navlink = document.querySelector('.nav-link'),
        close = document.querySelector('#close');

    iconbtn.addEventListener('click',function(){
      navbarbtn.style.display='block';
      navbarbtn.style.width='500px';
